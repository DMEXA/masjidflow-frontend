export const queryKeys = {
  ...
  muqtadiStats: ['muqtadi-stats'] as const,
  muqtadiSalarySummary: ['muqtadi-salary-summary'] as const,
  imamSalaryCycles: (mosqueId?: string) => ['imam-salary-cycles', mosqueId ?? 'none'] as const,
  muqtadiDetailRoot: ['muqtadi-detail'] as const,
  muqtadiDetail: (muqtadiId?: string) => ['muqtadi-detail', muqtadiId ?? 'none'] as const,
  muqtadiDetailDuesRoot: ['muqtadi-detail-dues'] as const,
  muqtadiDetailDues: (muqtadiId?: string) => ['muqtadi-detail-dues', muqtadiId ?? 'none'] as const,
  muqtadiPaymentsRoot: ['muqtadi-payments'] as const,
  muqtadiPayments: (muqtadiId?: string) => ['muqtadi-payments', muqtadiId ?? 'none'] as const,
  muqtadiHistoryRoot: ['muqtadi-history'] as const,
